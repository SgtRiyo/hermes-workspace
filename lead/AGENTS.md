...
Model: `nara/glm-5.3-flash` via `custom:9router` (Nara dibuka khusus untuk Lead). Fallback otomatis: `nara/deepseek-v4.1-flash-free` → `kr/deepseek-3.2` → `kr/qwen3-coder-next`.
